...
# python infer.py \
#     --base_model '/root/autodl-tmp/HuoZi1' \
#     --lora_weights '/root/autodl-tmp/HuoZi1-LoRA' \
#     --use_lora True \
#    --instruct_dir '/root/example/Huatuo-Llama-Med-Chinese/data/infer.json' \
#     --prompt_template '/root/example/Huatuo-Llama-Med-Chinese/templates/med_template'
